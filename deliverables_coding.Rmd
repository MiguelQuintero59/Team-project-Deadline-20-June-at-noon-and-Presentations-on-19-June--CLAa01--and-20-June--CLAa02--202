...
combined_df <- rbind(
  data.frame(train_genes[, selected_genes], Class = train_labels, Set = "Train"),
  data.frame(test_genes[, selected_genes], Class = test_labels, Set = "Test")
)

#Scale predictors
scaled_predictors <- scale(combined_df[, selected_genes])

# Reattach class and set labels
combined_scaled_df <- data.frame(scaled_predictors,
                                 Class = combined_df$Class,
                                 Set = combined_df$Set)

# Split back into train and test
lda_train_df <- subset(combined_scaled_df, Set == "Train")
lda_test_df <- subset(combined_scaled_df, Set == "Test")
