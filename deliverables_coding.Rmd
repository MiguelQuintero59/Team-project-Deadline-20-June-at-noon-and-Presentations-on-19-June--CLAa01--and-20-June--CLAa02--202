...
# Get overall accuracy from resampling results
accuracy_values <- model_rf$resample$Accuracy

# Calculate misclassification error per fold
misclassification_errors <- 1 - accuracy_values

cvrf_results <- data.frame(
  Fold = 1:length(misclassification_errors),
  Accuracy = accuracy_values,
  MisclassificationError = misclassification_errors
)
