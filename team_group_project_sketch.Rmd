...
# FEATURE SELECTION LDA + SHAPIRO WILK TEST + MODEL LDA (SIMILAR WITH MODEL #4)
```{r pressure, echo=FALSE}
# LDA Dimensionality Reduction and Model  -- VERSION 2
# Conclusion: The approach using LDA for dimensionality reduction was: 
...
# ---------------------------------------------------------------------------------------------------
#Double check if it really matters to use this plots
# Plot histogram of raw p-values
# hist(shapiro_pvals, breaks = 50, main = "Histogram of Shapiro-Wilk p-values", xlab = "p-value")
# Plot histogram of adjusted p-values
# hist(p_adj, breaks = 50, main = "Histogram of Adjusted p-values (FDR)", xlab = "Adjusted p-value")
# ---------------------------------------------------------------------------------------------------
